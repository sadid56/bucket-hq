...
export default function ConnectionsPage() {
  ...
  return (
    <Stack gap={6}>
      {/* Page Header */}
      <Flex align={{ base: "stretch", sm: "center" }} justify="space-between" pb={4} borderBottomWidth="1px" borderColor="border.subtle" gap={4} direction={{ base: "column", sm: "row" }}>
        <Stack gap={1}>
          <Heading size="lg" fontWeight="bold">Connections</Heading>
          <Text fontSize="sm" color="fg.muted">
            Manage credentials and configurations for your connected cloud storage providers.
          </Text>
        </Stack>
        <Button colorPalette="teal" onClick={() => setModal("add-connection")} gap={1.5} size="sm" alignSelf={{ base: "flex-start", sm: "auto" }}>
          <Plus size={16} />
