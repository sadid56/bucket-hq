...
import { Button, Stack, Box, Text, Flex, Spinner } from "@chakra-ui/react";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Flex align="center" justify="center" flex="1" bg="blackAlpha.200" borderRadius="md" p={2} overflow="hidden" minH="250px" maxH="60vh">
          {isLoading ? (
